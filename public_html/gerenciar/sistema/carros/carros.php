...
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/carros.php";
...
$smarty->assign('lista', $Carros->Lista($_REQUEST));
$smarty->display('sistema/carros/carros.html');