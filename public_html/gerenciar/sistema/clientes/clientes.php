...
$admin = (isset($_REQUEST['a']))?$_REQUEST['a']:null;

$_REQUEST['pg'] = $pg;
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['a'] = $admin;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/clientes.php";
...
$smarty->assign('lista', $Clientes->Lista($_REQUEST));
$smarty->display('sistema/clientes/clientes.html');