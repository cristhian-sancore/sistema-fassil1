...
if($_POST){
	if($ac=='i' && in_array($Mod_ID."a", $_SESSION['_user']['Permissao_Modulos'])){
		...
		$Cidades->Edita($_POST, $id);
	}

	header("Location:".urlBase."$Mod[0]/$Mod[1]/cidades.php");
}
...
$smarty->assign('ac', $ac);
$smarty->assign('dados', $Cidades->Dados($id));
$smarty->display('sistema/cidades/cidades_ie.html');