...
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/permissoes.php";
...
$smarty->assign('lista', $Permissoes->Lista($_REQUEST));
$smarty->display('sistema/permissoes/permissoes.html');