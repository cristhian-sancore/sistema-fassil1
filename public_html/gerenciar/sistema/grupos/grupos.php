...
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/grupos.php";
...
$smarty->assign('lista', $Grupos->Lista($_REQUEST));
$smarty->display('sistema/grupos/grupos.html');