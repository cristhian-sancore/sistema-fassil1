...
$corpo = "
    <div class='corpo'>
	    ...
	    <div class='cabecalho'>
	        ...
	        <!--dento do <p style='margin-left:30px;'> para colocar ele a 30px para o lado direito-->
	        <p>Início: <span>".$dc['OS_DataInicio']." às ".$dc['OS_HorasInicio']."</span></p>
	        <p>Término: <span>".$dc['DataFechamento']."</span></p>
...
$rodape = "
    <div class='rodape'>
	    <p>Rua Niterói, 740 - Jardim Popular - <b>Fone:(65)3251-3017</b> - CEP:78.285-000 - São José dos Quatro Marcos - MT</p>
