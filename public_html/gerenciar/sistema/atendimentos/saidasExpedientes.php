...
$ajax = "ajax_saidasExpedientes_acao.php";
...
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/saidasExpedientes.php";
...
$smarty->assign('lista', $SaidasExpedientes->Lista($_REQUEST));
$smarty->display('sistema/atendimentos/saidasExpedientes.html');