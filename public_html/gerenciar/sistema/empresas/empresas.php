...
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/empresas.php";
...
$smarty->assign('lista', $Empresas->Lista($_REQUEST));
$smarty->display('sistema/empresas/empresas.html');