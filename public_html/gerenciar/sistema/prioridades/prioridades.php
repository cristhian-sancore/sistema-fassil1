...
$ajax = "ajax_prioridades_acao.php";
...
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/prioridades.php";
...
$smarty->assign('lista', $Prioridades->Lista($_REQUEST));
$smarty->display('sistema/prioridades/prioridades.html');