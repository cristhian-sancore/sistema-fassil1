...
$_REQUEST['b'] = $busca;
$_REQUEST['s'] = $status;
$_REQUEST['link'] = urlBase."$Mod[0]/$Mod[1]/usuarios.php";
...
$smarty->assign('lista', $Usuarios->Lista($_REQUEST));
$smarty->display('sistema/usuarios/usuarios.html');