...
$smarty->assign('permissoes', $Permissoes->ListaPermissoes());
$smarty->assign('dados', $Usuarios->Dados($id));
$smarty->display('sistema/usuarios/usuarios_ie.html');