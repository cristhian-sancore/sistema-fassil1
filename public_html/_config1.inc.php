...
define('urlSite', 'https://www.grupofassil.com.br/sistema/');
define('urlBase', 'https://www.grupofassil.com.br/');

//------------------- DEFINE A BASE DA IMAGEM
// define('urlMidia', 'https://www.grupofassil.com.br/midias');

//------------------- CAMINHOS URL ACTIVE
$Mod = explode('sistema/', $_SERVER['REQUEST_URI']);
$Mod = explode('/', $Mod[1]);
/*$Mod = array(
    $Mod[1],
    $Mod[2],
